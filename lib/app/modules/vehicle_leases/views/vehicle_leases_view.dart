...
import 'vehicle_lease_detail_view.dart';

class VehicleLeasesView extends GetView<VehicleLeasesController> {
  const VehicleLeasesView({super.key});
            ...
            child: Obx(() {
              ...
              if (controller.leases.isEmpty) {
                return Center(
                  child: Column(
                    ...
                    children: [
                      const Icon(Icons.key_off_outlined, size: 48, color: AppColors.mutedText),
                      const SizedBox(height: 12),
                      Text('No leases found', style: AppTextStyles.body.copyWith(color: AppColors.mutedText)),
                    ],
                  ),
                );
              }
              return NotificationListener<ScrollNotification>(
                ...
                child: ListView.builder(
                  ...
                  itemCount: controller.leases.length + (controller.hasMore.value ? 1 : 0),
                  itemBuilder: (_, i) {
                    ...
                    return _LeaseCard(
                      lease: controller.leases[i],
                      onTap: () => Get.to(
                        () => const VehicleLeaseDetailView(),
                        arguments: controller.leases[i]['id'],
                      ),
                    );
                  },
                ),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if (lease['site'] != null && (lease['site'] as String).isNotEmpty) ...[
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 4),
                Text(
                  FerosDateUtils.formatDate(lease['startDate'] as String?),
                  style: AppTextStyles.caption.copyWith(color: AppColors.mutedText),
                ),
