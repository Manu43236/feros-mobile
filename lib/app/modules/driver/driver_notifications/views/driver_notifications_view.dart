...
class DriverNotificationsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<DriverNotificationsController>(
      init: DriverNotificationsController(),
  ...
  Widget _buildBody(DriverNotificationsController ctrl) {
    ...
    return RefreshIndicator(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (_, i) => _NotifTile(n: ctrl.notifications[i]),
      ),
    );
  }
}
