...
class _OfficeAttendanceViewState extends State<OfficeAttendanceView>
  ...
  void initState() {
    super.initState();
    Get.lazyPut<OfficeAttendanceController>(
        () => OfficeAttendanceController());
...
class _DailyTab extends StatelessWidget {
        ...
        Obx(() {
          ...
          return Container(
            ...
            child: Row(children: [
              ...
              if ((s['unmarked'] ?? 0) > 0)
                _StatChip('Unmarked', '${s['unmarked']}', AppColors.mutedText),
            ]),
          );
        }),
            ...
            if (rows.isEmpty) {
              return Center(
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Text('No staff or records found',
                ...
                itemBuilder: (_, i) {
                  ...
                  return _AttendanceRow(
                    ...
                    onTap: () => _showMarkSheet(
                        context, ctrl, isMarked ? row : null,
                        preUserId: isMarked
                            ? null
  ...
  void _showMarkSheet(BuildContext context,
      OfficeAttendanceController ctrl, Map<String, dynamic>? record,
      {int? preUserId}) {
...
class _PendingTab extends StatelessWidget {
                ...
                : RefreshIndicator(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (_, i) => _PendingCard(
                        record: list[i],
                        onApprove: () => _handle(context,
                            () => ctrl.approve(
                                (list[i]['id'] as num).toInt()),
                            'Attendance approved'),
                        onReject: () => _handle(context,
                            () => ctrl.reject(
                                (list[i]['id'] as num).toInt()),
                            'Attendance rejected'),
                      ),
  ...
  Future<void> _handle(BuildContext context, Future<void> Function() action,
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (_, i) => _RejectedCard(
                        ...
                        onApprove: () async {
                          try {
                            await ctrl
                                .approve((list[i]['id'] as num).toInt());
...
class _RejectedCard extends StatelessWidget {
  ...
  final VoidCallback onApprove;
  const _RejectedCard(
      {required this.record, required this.onApprove});
...
class _MarkAttendanceSheet extends StatefulWidget {
  ...
  const _MarkAttendanceSheet(
      {required this.ctrl, this.record, this.preUserId});
...
class _MarkAttendanceSheetState extends State<_MarkAttendanceSheet> {
  ...
  bool get _isLeave {
    ...
    final type = widget.ctrl.attendanceTypes
        .firstWhereOrNull((t) => (t['id'] as num?)?.toString() == _typeId);
    ...
    try {
      ...
      final body = <String, dynamic>{
        ...
        if (_leaveTypeId != null)
          'leaveTypeId': int.parse(_leaveTypeId!),
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Row(children: [
              Text(_isEdit ? 'Edit Attendance' : 'Mark Attendance',
                  style: AppTextStyles.heading4
                      .copyWith(color: AppColors.navy)),
              const Spacer(),
              IconButton(
                ...
                child: _loading
                    ? const SizedBox(
                        ...
                        child: CircularProgressIndicator(
                            color: Colors.white,
                            strokeWidth: 2))
                    : Text(_isEdit ? 'Update' : 'Mark Attendance',
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(8),
          border: Border.all(
              color: isSet ? AppColors.navy : AppColors.border),
        ),
        child: Row(children: [
